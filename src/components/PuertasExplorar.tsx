// EL SUMARIO — las tres puertas grandes de Explorar.
//
...
//
// Ahora es el SUMARIO de la publicación, que es exactamente lo que estas tres
// puertas son: cada sección con su número romano, su nombre en display y la
// frase que dice en qué se diferencia de las otras dos. El ROADMAP lleva
// avisando desde la Fase 8 de que si no se explica la diferencia, se
// canibalizan — en un sumario esa frase es literalmente el formato.
